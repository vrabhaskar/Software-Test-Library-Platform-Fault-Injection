...
uint8_t expectedColorID[SAMPLES] = {
  1,2,3,1,2,3,1,2,3,2
};
...
void onReceive(int len) {
  ...
  else if (lastCmd == CMD_DATA&& I2CBUS2.available()) {
    reqIndex  = I2CBUS2.read();
    data= detected[reqIndex];
  }
}
...
void onRequest() {
  ...
  if (lastCmd == CMD_STATUS) {
    I2CBUS2.write(status);
       ...
       I2CBUS2.write((uint8_t*)&data, sizeof(int32_t));
